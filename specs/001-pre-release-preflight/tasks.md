...
- [ ] T001 Create shared pre-release utilities module in scripts/prerelease/utils.mjs with baseline helpers for reading package.json; optional script discovery and execution logic is defined in T012
