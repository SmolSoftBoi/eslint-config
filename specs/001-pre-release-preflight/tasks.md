...
- [ ] T001 Create shared pre-release utilities module in scripts/prerelease/utils.mjs with baseline helpers for reading package.json; T012 extends these helpers with optional script discovery and execution logic
