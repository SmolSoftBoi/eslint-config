...
- [ ] T012 Update preflight logic in scripts/prerelease/utils.mjs to conditionally run typecheck/test when package.json includes those scripts (skip if absent)
...
- T008 can be done in parallel with US2 after T002
