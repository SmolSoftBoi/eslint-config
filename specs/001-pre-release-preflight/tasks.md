...
- [ ] T001 Create shared pre-release utilities module in scripts/prerelease/utils.mjs with baseline helpers for reading package.json and checking for optional script presence
