...
- T020 defines the skip/fail-fast behavior for optional scripts when using the T012 helpers.
...
- T015 validates the mandatory `lint` script (FR-001a in `spec.md`) and uses the T012 helpers to run optional scripts.
