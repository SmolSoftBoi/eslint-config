...
- [ ] T001 Create shared pre-release utilities module in scripts/prerelease/utils.mjs with baseline helpers for reading package metadata and detecting which optional scripts exist in package.json
