...
- [ ] T001 Create shared pre-release utilities module in scripts/prerelease/utils.mjs with helpers for reading package metadata and scripts defined in package.json
